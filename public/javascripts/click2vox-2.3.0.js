...
(function (click2vox) {
  ...
  var loadAssets = (function() {
    Array.prototype.forEach.call(voxButtonElements, function(voxButtonElement) {
      ...
      if (click2vox.did === undefined && !predefinedHtmlButton) {
        console.log('Voxbone DID number is not defined.');
        return;
      }
  ...
  var renderWidget = (function(){
    ...
    if (voxButtonElement) voxButtonElement.insertAdjacentHTML('beforeend', voxPopup);
    editText(customText);
